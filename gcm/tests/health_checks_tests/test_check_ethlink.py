...
NMCLI_CHECK_OUTPUT_PATH = "gcm.health_checks.checks.check_ethlink.subprocess.check_output"
...
def test_nmcli_fallback_happy_path() -> None:
    with patch(NMCLI_CHECK_OUTPUT_PATH, return_value=SAMPLE_NMCLI_DEVICE_OUTPUT.encode()):
