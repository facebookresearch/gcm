...
### Requirements
- **Python 3.11+** (currently tested on 3.11, later versions should work)
...
Python 3.11 or greater is required. Currently only 3.11 is tested, but later versions should work as well.
